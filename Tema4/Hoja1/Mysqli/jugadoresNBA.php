...
<body class="jumbotron">
    ...
    <?php if (isset($_POST['enviar2'])) :  ?>
        <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
            ...
            <p><input type='submit' value='Realizar Traspaso' id='Traspaso' name=''> </p>
        </form>
    <?php endif; ?>
    ...
    if (isset($_POST['Traspaso'])) {
        ...
        if (setTraspaso($_POST['jugador'], $_POST['Nombre'], $_POST['Procedencia'], $_POST['Altura'], $_POST['Peso'], $_POST['Posicion'], $_POST['equipos2']) == true) {
            echo "Se realizo el traspaso con exito";
        }
    };
    ?>
